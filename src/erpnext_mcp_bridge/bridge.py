...
class ERPNextMCPBridge:
    ...
    def _error_response(self, code: int, message: str, data: Any = None, req_id: Any = None) -> Dict:
    ...
    def _send_to_server(self, request_data: Dict) -> Dict:
        ...
        try:
            ...
            if resp.status_code == 200:
                ...
                return self._error_response(-32603, f"Server error: {resp.status_code}", resp.text[:500], req_id)
            ...
            return self._error_response(-32603, "Connection failed", f"Cannot reach {self.server_url}", req_id)
        except Exception as e:
            self._log_error(f"Request failed: {e}")
            return self._error_response(-32603, "Internal error", str(e), req_id)

    def _handle_local(self, request: Dict) -> Dict:
    ...
    def _process_request(self, request: Dict):
        ...
        try:
            ...
            if request.get("id") is not None:
                with self.output_lock:
                    print(json.dumps(self._error_response(-32603, str(e), None, request.get("id"))), flush=True)
        ...
        try:
            for line in sys.stdin:
                ...
                try:
                    ...
                    print(json.dumps(self._error_response(-32700, "Parse error", str(e))), flush=True)
